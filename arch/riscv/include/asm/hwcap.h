...
#define RISCV_ISA_EXT_ZCHERIPURECAP	106
#define RISCV_ISA_EXT_ZCHERIHYBRID	107
#define RISCV_ISA_EXT_ZCHERIPTE		108
#define RISCV_ISA_EXT_ZISH4ADD		109
#define RISCV_ISA_EXT_ZABHLRSC		110
#define RISCV_ISA_EXT_ZCHERILEVELS	111
