...
typedef struct __c64_user_regs_struct __c64_elf_gregset_t;

static __always_inline __maybe_unused void
__from_c64_elf_gregset_t(elf_gregset_t *p)
{
	union {
		elf_gregset_t native;
		const __c64_elf_gregset_t compat;
	} *u = (void *)p;
...
static __always_inline __maybe_unused void
__to_c64_elf_gregset_t(elf_gregset_t *p)
{
	union {
		__c64_elf_gregset_t compat;
		const elf_gregset_t native;
	} *u = (void *)p;
...
static __always_inline __maybe_unused void
__from_c64_elf_gregset_t_2(elf_gregset_t *native, const __c64_elf_gregset_t *compat)
{
...
static __always_inline __maybe_unused void
__to_c64_elf_gregset_t_2(__c64_elf_gregset_t *compat, const elf_gregset_t *native)
{
