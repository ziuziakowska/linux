...
__from_c64_user_regs_struct(struct user_regs_struct *p)
{
	union {
		struct user_regs_struct native;
		const struct __c64_user_regs_struct compat;
	} *u = (void *)p;
...
static __always_inline __maybe_unused void
__to_c64_user_regs_struct(struct user_regs_struct *p)
{
	union {
		struct __c64_user_regs_struct compat;
...
static __always_inline __maybe_unused void
__from_c64_user_regs_struct_2(struct user_regs_struct *native, const struct __c64_user_regs_struct *compat)
{
...
static __always_inline __maybe_unused void
__to_c64_user_regs_struct_2(struct __c64_user_regs_struct *compat, const struct user_regs_struct *native)
{
