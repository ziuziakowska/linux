...
+----------------------------------+------------------+----------------+------------------------------------------------------------------------------------+
| | ``void __capability *``        | Capability       | Capability     | Only available on CHERI-enabled architectures (``__has_feature(capabilities)``).   |
| | ``void * __capability``        |                  |                |                                                                                    |
+----------------------------------+------------------+----------------+------------------------------------------------------------------------------------+
| ``uintcap_t``                    | Capability       | Capability     | * Only available on CHERI-enabled architectures (``__has_feature(capabilities)``). |
